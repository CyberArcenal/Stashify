...
import type { LowStockReportData } from "../../../../api/analytics/lowStock";
import lowStockAPI from "../../../../api/analytics/lowStock";
...
interface UseLowStockReportReturn {
  reportData: LowStockReportData | null;
  loading: boolean;
  error: string | null;
  refreshing: boolean;
  filters: Filters;
  ...
  resetFilters: () => void;
  filteredItems: LowStockReportData["stockItems"];
  paginatedItems: LowStockReportData["stockItems"];
  pagination: {
    current_page: number;
    total_pages: number;
    count: number;
...
const useLowStockReport = (): UseLowStockReportReturn => {
...
export default useLowStockReport;