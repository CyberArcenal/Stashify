...
async function getGeneralCurrencySign() {
  // @ts-ignore
  return getValue("general_currency_sign", SettingType.GENERAL, "₱");
}

async function getGeneralCurrency() {
  // @ts-ignore
  return getValue("general_currency", SettingType.GENERAL, "PHP");
}
...
async function supplierTaxRate() {
  return getInt("supplier_tax_rate", SettingType.SUPPLIER_TAX, 0);
}
...
async function getNotifyCustomerOnOrderConfirmedWithEmail() {
  return getBool(
...
async function getNotifyCustomerOnOrderConfirmedWithSms() {
  return getBool(
...
async function getNotifyCustomerOnOrderCompletedWithEmail() {
  return getBool(
...
async function getNotifyCustomerOnOrderCompletedWithSms() {
  return getBool(
...
async function getNotifyCustomerOnOrderCancelledWithEmail() {
  return getBool(
...
async function getNotifyCustomerOnOrderCancelledWithSms() {
  return getBool(
...
async function getNotifyCustomerOnOrderRefundedWithEmail() {
  return getBool(
...
async function getNotifyCustomerOnOrderRefundedWithSms() {
  return getBool(
...
async function autoUpdateStockOnOrderConfirm() {
  return getBool(
...
async function autoUpdateStockOnOrderComplete() {
  return getBool(
...
async function autoReverseStockOnOrderCancel() {
  return getBool(
...
async function autoReverseStockOnOrderRefund() {
  return getBool(
...
async function loyaltyPointsEarnOnConfirm() {
  return getBool("loyalty_points_earn_on_confirm", SettingType.SALES, true); // default true
}

// Supplier purchase order notifications
async function getNotifySupplierOnPurchaseConfirmedWithEmail() {
  return getBool(
...
async function getNotifySupplierOnPurchaseConfirmedWithSms() {
  return getBool(
...
async function getNotifySupplierOnPurchaseReceivedWithEmail() {
  return getBool(
...
async function getNotifySupplierOnPurchaseReceivedWithSms() {
  return getBool(
...
async function getNotifySupplierOnPurchaseCancelledWithEmail() {
  return getBool(
...
async function getNotifySupplierOnPurchaseCancelledWithSms() {
  return getBool(
...
async function autoUpdateStockOnPurchaseReceived() {
  return getBool(
...
async function autoReverseStockOnPurchaseCancel() {
  return getBool(
...
module.exports = {
  ...
  getGeneralCurrency,
  // New customer order notification settings
  ...
  // New stock auto-update settings
  ...
  // New supplier purchase notifications
