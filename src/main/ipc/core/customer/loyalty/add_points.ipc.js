// src/main/ipc/customer/loyalty/add_points.ipc.js
// @ts-check
 ...
 * @param {number} params.points - Points to add (positive integer)
...
module.exports = async (params, queryRunner, user = "system") => {
  try {
    ...
    const transactionRepo =
      // @ts-ignore
      queryRunner.manager.getRepository(LoyaltyTransaction);
    ...
    customer.lifetimePointsEarned =
      (customer.lifetimePointsEarned || 0) + points;
