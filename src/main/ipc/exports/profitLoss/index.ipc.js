...
class ProfitLossExportHandler {
  ...
  async _exportCSV(data, params) {
    ...
    csvContent.push("Generated by,stashly Financial Management System v2.0");
  ...
  async _exportExcel(data, params) {
    try {
      ...
      workbook.creator = "stashly Financial System";
    ...
    try {
      ...
      const doc = new PDFKit({
        ...
        info: {
          ...
          Author: "stashly Financial System",
  ...
  _createCoverPage(doc, data) {
    ...
    doc
      ...
      .fillColor(this.CHART_COLORS.light)
      .text(
        "stashly Financial Management System",
        margin,
        headerPaddingTop + 92,
        {
          width: pageWidth - margin * 2,
    ...
    try {
      ...
      for (let i = 0; i < totalPages; i++) {
        ...
        doc
          ...
          .fillColor("#999999")
          .text(
            `Profit & Loss Report | Generated: ${new Date().toLocaleDateString()} | stashly Financial v2.0 | Report Type: ${data.metadata.report_type} | Confidential`,
            40,
            doc.page.height - 20,
