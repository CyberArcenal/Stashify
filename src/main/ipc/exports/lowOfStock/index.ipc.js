...
class LowStockExportHandler {
  ...
  async _exportCSV(data, params) {
    ...
    csvContent.push("Generated by,Stashify Management System v2.0");
  ...
  async _exportExcel(data, params) {
    try {
      ...
      workbook.creator = "Stashify Management System";
      ...
      // Add logo/header
      const logoRow = coverSheet.addRow(["Stashify SYSTEM"]);
    ...
    try {
      ...
      const doc = new PDFKit({
        ...
        info: {
          ...
          Author: "Stashify Management System",
  ...
  _createCoverPage(doc, data) {
    ...
    doc
      .fontSize(10)
      .fillColor(this.CHART_COLORS.light)
      .text("Stashify Management System", margin, headerPaddingTop + 92, {
        width: pageWidth - margin * 2,
        align: "center",
      });
    doc.restore();
    ...
    try {
      ...
      for (let i = 0; i < totalPages; i++) {
        ...
        doc
          ...
          .fillColor("#999999")
          .text(
            `Low Stock Report | Generated: ${new Date().toLocaleDateString()} | Stashify v2.0 | Report Type: ${data.metadata.report_type} | Confidential`,
            40,
            doc.page.height - 20,
