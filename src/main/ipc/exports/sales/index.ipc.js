...
class SalesReportExportHandler {
  ...
  async _exportCSV(data, params) {
    ...
    csvContent.push("Generated by,Stashify Sales Analytics v2.0");
  ...
  async _exportExcel(data, params) {
    try {
      ...
      workbook.creator = "Stashify Sales Analytics";
    ...
    try {
      ...
      const doc = new PDFKit({
        ...
        info: {
          ...
          Author: "Stashify Sales Analytics",
  ...
  _createCoverPage(doc, data) {
    ...
    doc
      .fontSize(10)
      .fillColor(this.CHART_COLORS.light)
      .text("Stashify Sales Analytics", margin, headerPaddingTop + 92, {
        width: pageWidth - margin * 2,
        align: "center",
      });
    doc.restore();
    ...
    try {
      ...
      for (let i = 0; i < totalPages; i++) {
        ...
        doc
          ...
          .fillColor("#999999")
          .text(
            `Sales Performance Report | Generated: ${new Date().toLocaleDateString()} | Stashify Sales Analytics v2.0 | Report Type: ${data.metadata.report_type} | Confidential`,
            40,
            doc.page.height - 20,
